function getSmallMaze() {
  return {
    board: [[
      ...
      { id:  4, x: 0, y: 1, boundaries: 11, algoVisited: true, playerVisited: true,  isGoal: false, isStart: false },
      { id:  5, x: 1, y: 1, boundaries:  9, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id:  6, x: 2, y: 1, boundaries: 15, algoVisited: true, playerVisited: true,  isGoal: false, isStart: false },
    ], [
      { id:  7, x: 0, y: 2, boundaries: 13, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id:  8, x: 1, y: 2, boundaries:  0, algoVisited: true, playerVisited: true,  isGoal: false, isStart: false },
      { id:  9, x: 2, y: 2, boundaries:  0, algoVisited: true, playerVisited: true,  isGoal: true, isStart: false },
    ]],
  };
}

function getVariedMaze() {
  return {
    board: [[
...
// Technically this maze is braided *and* woven
function getMazeWithBridges() {
  return {
    board: [[
      { id:  1, x: 0, y: 0, boundaries:  8, algoVisited: true, playerVisited: false, isGoal: false, isStart: true  },
      { id:  2, x: 1, y: 0, boundaries:  1, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id:  3, x: 2, y: 0, boundaries:  1, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id:  4, x: 3, y: 0, boundaries:  3, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
    ], [
      { id:  5, x: 0, y: 1, boundaries:  8, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id:  6, x: 1, y: 1, boundaries:  0, algoVisited: true, playerVisited: false, isGoal: false, isStart: false, isBridge: true, bridgeDirection: 'v' },
      { id:  7, x: 2, y: 1, boundaries:  0, algoVisited: true, playerVisited: false, isGoal: false, isStart: false, isBridge: true, bridgeDirection: 'h' },
      { id:  8, x: 3, y: 1, boundaries:  2, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
    ], [
      { id:  9, x: 0, y: 2, boundaries:  8, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id: 10, x: 1, y: 2, boundaries:  0, algoVisited: true, playerVisited: false, isGoal: false, isStart: false, isBridge: true, bridgeDirection: 'h' },
      { id: 11, x: 2, y: 2, boundaries:  0, algoVisited: true, playerVisited: false, isGoal: false, isStart: false, isBridge: true, bridgeDirection: 'v' },
      { id: 12, x: 3, y: 2, boundaries:  2, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
    ], [
      { id: 13, x: 0, y: 3, boundaries: 12, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id: 14, x: 1, y: 3, boundaries:  4, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id: 15, x: 2, y: 3, boundaries:  4, algoVisited: true, playerVisited: false, isGoal: false, isStart: false },
      { id: 16, x: 3, y: 3, boundaries:  2, algoVisited: true, playerVisited: false, isGoal: true,  isStart: false },
    ]]
  };
}
